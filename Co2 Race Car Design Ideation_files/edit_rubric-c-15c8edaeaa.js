...
var b=n("EvX+")
var _=u.a.default
var h=_.template,p=_.templates=_.templates||{}
var g="editor/KeyboardShortcuts"
p[g]=h((function(e,t,n,o,r){this.compilerInfo=[4,">= 1.0.0"]
n=this.merge(n,e.helpers)
r=r||{}
var a,i="",s="function",l=this.escapeExpression,c=this
function d(e,t){var o,r,a=""
a+="\n    <li>\n      <code>"
if(r=n.key)o=r.call(e,{hash:{},data:t})
else{r=e&&e.key
o=typeof r===s?r.call(e,{hash:{},data:t}):r}a+=l(o)+"</code>\n      <span>"
if(r=n.description)o=r.call(e,{hash:{},data:t})
else{r=e&&e.description
o=typeof r===s?r.call(e,{hash:{},data:t}):r}a+=l(o)+"</span>\n    </li>\n  "
return a}i+='<ul class="tinymce-keyboard-shortcuts">\n  '
a=n.each.call(t,t&&t.keybindings,{hash:{},inverse:c.noop,fn:c.program(1,d,r),data:r});(a||0===a)&&(i+=a)
i+="\n</ul>\n"
return i}))
...
t["a"]=u={quoteClump:function(e){return"<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>"+Object(l["a"])(s.t("quoted_text_toggle","show quoted text"))+"</a> <div class='quoted_text' style='display: none;'> "+r.a.raw(e.join("\n"))+" </div> </div>"},formatMessage:function(e){var t,n,o,r,a,i,s,b
r=[]
a=[]
e=e.replace(d,(function(e,t){var n
a.push(e===c?c:(n=e,"http://"===n.slice(0,7)||"https://"===n.slice(0,8)||(n="http://"+n),r.push(n),"<a href='"+Object(l["a"])(n)+"'>"+Object(l["a"])(e)+"</a>"))
return c}))
e=Object(l["a"])(e)
...
return i.join("\n")},delimit:function(e){var t,n,o,r,a
...
n=Math.floor(n/1e3)
r=o+r}return a+String(n)+r},truncateText:function(e,t){var n,o,r,a,i,l
null==t&&(t={})
o=null!=(a=t.max)?a:30
n=s.t("ellipsis","...")
...
if(r<0||r>o-n.length)break
i=r}i||(i=o-n.length)
return e.substring(0,i)+n},plainText:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}},"5JRF":function(e,t,n){"use strict"
var o=n("rePB")
var r=n("1OyB")
var a=n("vuIU")
var i=n("md7G")
...
return"(".concat(a(r.toLowerCase()),": ").concat(Object(o["a"])(s,t),"px)")}function a(e){return e.slice(0,3)+"-"+e.slice(3)}},B1vq:function(e,t,n){"use strict"
var o=n("ouhR")
var r=n.n(o)
n("s/PJ")
...
let o=n.offset(),a=n.outerWidth(),i=n.outerHeight(),s=o.top,l=s+i,c=o.left,d=c+a,u="html,body"==this.selector?r.a.windowScrollTop():this.scrollTop(),b=this.scrollLeft(),_=this.outerHeight(),h=this.outerWidth()
...
l-=e.top
c-=e.left
d-=e.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){_=r()(window).height()
r()("#wizard_box:visible").length>0&&(_-=r()("#wizard_box:visible").height())
h=r()(window).width()
s-=u
c-=b
l-=u
d-=b}s<0||_<i&&l>_?t.scrollTop=s+u:l>_&&(t.scrollTop=l+u-_+20)
c<0?t.scrollLeft=c+b:d>h&&(t.scrollLeft=d+b-h+20)
...
return{name:e,value:t}}function b(){const e=r()(this)
...
return r.a.isArray(t)?t.map(e=>u(this.name,e)):u(this.name,t)}r.a.fn.serializeForm=function(){return this.map(c).filter(d).map(b).get()}},"EvX+":function(e,t,n){"use strict"
var o=n("HIhM")
const r={}
...
const r=o?"no_variables":a.getCssVariant()
return[window.ENV.ASSET_HOST||"","dist","brandable_css",r,"".concat(e,"-").concat(n,".css")].join("/")},loadStylesheet(e,t){if(e in r)return
...
var r=Object(c["a"])(e),a=Object(o["a"])(r,2),i=a[0],s=a[1]
return"rem"===s?i*l():"em"===s?i*l(n):i}},HbFp:function(e,t,n){"use strict"
var o=n("qJBq")
var r=n.n(o)
var a=n("pQTu")
...
r.a.isReady?a():r()(document).ready(()=>a())},RhCJ:function(e,t,n){"use strict"
...
var S=(O=Object(f["a"])("7.0.0",{label:"renderLabel",disabled:"interaction",readOnly:"interaction",required:"isRequired",inline:"display"}),U=Object(x["themeable"])(B,z),O(C=U(C=(q=H=function(e){Object(c["a"])(t,e)
function t(e){var n
Object(a["a"])(this,t)
...
n._defaultId=Object(j["a"])("TextInput")
n._messagesId=Object(j["a"])("TextInput-messages")
return n}Object(i["a"])(t,[{key:"focus",value:function(){this._input.focus()}},{key:"renderInput",value:function(){var e
var t=this.props,n=t.type,a=t.size,i=t.textAlign,s=t.placeholder,l=t.value,c=t.defaultValue,d=t.disabled,b=t.readOnly,_=t.interaction,h=t.required,g=t.isRequired,f=Object(r["a"])(t,["type","size","textAlign","placeholder","value","defaultValue","disabled","readOnly","interaction","required","isRequired"])
var y=Object(m["b"])(f)
var v=(e={},Object(o["a"])(e,z.input,true),Object(o["a"])(e,z[a],a),Object(o["a"])(e,z["textAlign--".concat(i)],i),e)
var k=""
y["aria-describedby"]&&(k="".concat(y["aria-describedby"]))
this.hasMessages&&(k=""!==k?"".concat(k," ").concat(this._messagesId):this._messagesId)
return u.a.createElement("input",Object.assign({},y,{className:p()(v),defaultValue:c,value:l,placeholder:s,ref:this.handleInputRef,type:n,id:this.id,required:g||h,"aria-invalid":this.invalid?"true":null,disabled:"disabled"===_||d,readOnly:"readonly"===_||b,"aria-describedby":""!==k?k:null,onChange:this.handleChange,onBlur:this.handleBlur,onFocus:this.handleFocus}))}},{key:"render",value:function(){var e
var t=this.props,n=t.interaction,r=t.disabled,a=t.width,i=t.inline,s=t.display,l=t.label,c=t.renderLabel,d=t.renderBeforeInput,b=t.renderAfterInput,_=t.messages,h=t.inputContainerRef,g=t.icon
var f=d||b||g
var m=(e={},Object(o["a"])(e,z.facade,true),Object(o["a"])(e,z.disabled,"disabled"===n||r),Object(o["a"])(e,z.invalid,this.invalid),Object(o["a"])(e,z.focused,this.state.hasFocus),e)
return u.a.createElement(k["FormField"],{id:this.id,label:Object(y["a"])(c||l),messagesId:this._messagesId,messages:_,inline:"inline-block"===s||i,width:a,inputContainerRef:h,layout:this.props.layout},u.a.createElement("span",{className:p()(m)},f?u.a.createElement(w["a"],{wrap:"wrap"},d&&u.a.createElement(w["a"].Item,{padding:"0 0 0 small"},Object(y["a"])(d)),u.a.createElement(w["a"].Item,{shouldGrow:true,shouldShrink:true},u.a.createElement(w["a"],{__dangerouslyIgnoreExperimentalWarnings:true},u.a.createElement(w["a"].Item,{shouldGrow:true,shouldShrink:true},this.renderInput()),(b||g)&&u.a.createElement(w["a"].Item,{padding:"0 small 0 0"},b?Object(y["a"])(b):Object(y["a"])(g))))):this.renderInput()))}},{key:"hasMessages",get:function(){return this.props.messages&&this.props.messages.length>0}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"focused",get:function(){return Object(v["a"])(this._input)}},{key:"value",get:function(){return this._input.value}},{key:"id",get:function(){return this.props.id||this._defaultId}}])
t.displayName="TextInput"
return t}(d["Component"]),H.propTypes={renderLabel:_.a.oneOfType([_.a.node,_.a.func]),type:_.a.oneOf(["text","email","url","tel","search","password"]),id:_.a.string,value:Object(g["a"])(_.a.string),defaultValue:_.a.string,interaction:_.a.oneOf(["enabled","disabled","readonly"]),messages:_.a.arrayOf(k["FormPropTypes"].message),size:_.a.oneOf(["small","medium","large"]),textAlign:_.a.oneOf(["start","center"]),width:_.a.string,display:_.a.oneOf(["inline-block","block"]),placeholder:_.a.string,isRequired:_.a.bool,inputRef:_.a.func,inputContainerRef:_.a.func,renderBeforeInput:_.a.oneOfType([_.a.node,_.a.func]),renderAfterInput:_.a.oneOfType([_.a.node,_.a.func]),onChange:_.a.func,onBlur:_.a.func,onFocus:_.a.func,icon:_.a.func,label:_.a.oneOfType([_.a.node,_.a.func]),disabled:_.a.bool,readOnly:_.a.bool,required:_.a.bool,inline:_.a.bool},H.defaultProps={renderLabel:void 0,type:"text",id:void 0,interaction:"enabled",isRequired:false,value:void 0,defaultValue:void 0,display:"block",placeholder:void 0,width:void 0,size:"medium",textAlign:"start",messages:[],inputRef:function(e){},inputContainerRef:function(e){},onChange:function(e,t){},onBlur:function(e){},onFocus:function(e){},renderBeforeInput:void 0,renderAfterInput:void 0},q))||C)||C)},cClk:function(e,t,n){"use strict"
n.d(t,"a",(function(){return o}))
...
if(i)return i
if(o[r]&&"function"!==typeof o[t])return new Error(["You provided a '".concat(r,"' prop without an '").concat(t,"' handler on '").concat(a,"'. This will render a controlled component. If the component should be uncontrolled and manage its own state, use '").concat(n,"'. Otherwise, set '").concat(t,"'.")].join(""))}}},cbNQ:function(e,t,n){"use strict"
n.d(t,"a",(function(){return r}))
n.d(t,"b",(function(){return a}))
const o={}.hasOwnProperty
function r(e,t){for(const n in t)o.call(t,n)&&(e[n]=t[n])
...
function _(){return document.getElementById("flash_screenreader_holder")}function h(e){let t=e.label,n=e.closeButtonLabel,a=e.onDismiss,c=e.children,d=Object(r["a"])(e,["label","closeButtonLabel","onDismiss","children"])
return i.a.createElement(b["a"],Object.assign({liveRegion:_},d,{label:t,onDismiss:a}),Object(o["a"])(b["a"].Header,{},void 0,Object(o["a"])(s["a"],{placement:"end",offset:"medium",onClick:a},void 0,n||u.t("Close")),Object(o["a"])(l["a"],{},void 0,t)),c)}["Header","Body","Footer"].forEach(e=>h[e]=b["a"][e])
h.defaultProps={closeButtonLabel:void 0}},eGSd:function(e,t,n){"use strict"
n.d(t,"a",(function(){return o}))
...
var _=u?Math.max(+n.maxWait||0,t):0
function h(t){var n=o
var i=r
o=r=void 0
s=t
if(true!==c){a=e.apply(i,n)
return a}}function p(e){s=e
l.push(setTimeout(m,t))
return d?h(e):a}function g(e){var n=e-i
var o=e-s
var r=t-n
return u?Math.min(r,_-o):r}function f(e){var n=e-i
var o=e-s
return"undefined"===typeof i||n>=t||n<0||u&&o>=_}function m(){var e=Date.now()
if(f(e))return y(e)
l.push(setTimeout(m,g(e)))}function y(e){w()
if(b&&o)return h(e)
o=r=void 0
return a}function v(){c=true
w()
s=0
o=i=r=void 0}function k(){return 0===l.length?a:y(Date.now())}function w(){l.forEach((function(e){return clearTimeout(e)}))
l=[]}function j(){var e=Date.now()
var n=f(e)
for(var s=arguments.length,c=new Array(s),d=0;d<s;d++)c[d]=arguments[d]
o=c
r=this
i=e
if(n){if(0===l.length)return p(i)
if(u){l.push(setTimeout(m,t))
return h(i)}}0===l.length&&l.push(setTimeout(m,t))
return a}j.cancel=v
j.flush=k
return j}},fQ4S:function(e,t,n){"use strict"
var o=n("ouhR")
var r=n.n(o)
var a=n("GLiE")
var i=n.n(a)
...
return n},showErrors:function(e,t){var n,o,a,i,l,c,d,u
null==t&&(t=false)
u=[]
for(a in e){o=e[a]
n=o.element||this.findField(a,t)
i=o.message||function(){var e,t,n,r
r=[]
for(e=0,t=o.length;e<t;e++){l=o[e].message
r.push(Object(s["a"])((null!=(n=this.translations)?n[l]:void 0)||l))}return r}.call(this).join("</p><p>")
null!=(c=n.errorBox(r.a.raw(""+i)))&&null!=(d=c.css("z-index","1100"))&&d.attr("role","alert")
...
o=n?n.split(" "):[]
return i.a.without(o,t+"_sr_description")}}},gCYW:function(e,t,n){"use strict"
n.d(t,"a",(function(){return s}))
var o=n("QF4Q")
var r=n("i/8D")
var a=n("EgqM")
...
var k=n("jtGx")
var w=n("oXx0")
function j(e){var t=e.borders,n=e.colors,o=e.spacing,r=e.typography
...
const r=function(){if(!o){e.cancelled&&s.a.isFunction(e.cancelled)&&e.cancelled.call(t)
...
s.a.ajaxJSON(e.url,"DELETE",o,n=>{e.success.call(t,n)},(n,o,r,a)=>{e.error&&s.a.isFunction(e.error)?e.error.call(t,n,o,r,a):s.a.ajaxJSON.unhandledXHRs.push(o)})}else{e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})})
e.success.call(t)}}
...
n=s()(e.message).dialog(s.a.extend({},{modal:true,close:r,buttons:[{text:a.t("#buttons.cancel","Cancel"),click(){s()(this).dialog("close")}},{text:a.t("#buttons.delete","Delete"),class:i,click(){o=true
s()(this).dialog("close")}}]},t))
return}o=confirm(e.message)}r()}
...
e.doc[0]==r[0]&&(a=true)}a||s.a._checkFragments.fragmentList.push({doc:r,fragment:""})
s()(window).bind("hashchange",s.a._checkFragments)
setTimeout(()=>{o&&o.length>0?r.triggerHandler("document_fragment_change",o):r&&r[0]&&r[0].location&&r[0].location.hash.length>0&&r.triggerHandler("document_fragment_change",r[0].location.hash)},500)}else this.triggerHandler("document_fragment_change",this[0].location.hash)
return this}
...
t.css({width:o+6,height:r+6,top:n.top-3,left:n.left-3,zIndex:a+1,position:"absolute",display:"block","-moz-border-radius":5,opacity:.8,border:"2px solid #870",backgroundColor:"#fd0"})
...
return this}
s.a.fn.fillWindowWithMe=function(e){const t=s.a.extend({minHeight:400},e),n=s()(this),o=s()("#wrapper"),r=s()("#main"),a=s()("#not_right_side"),i=s()(window),l=s()(this).add(t.alsoResize)
function c(){l.height(0)
const e=i.height()-(o.offset().top+o.outerHeight())+(r.height()-a.height()),c=Math.max(400,e)
l.height(c)
...
this.filter("input:text").each((function(){let t=e.minWidth||s()(this).width(),n="",o=s()(this),r=s()("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:o.css("fontSize"),fontFamily:o.css("fontFamily"),fontWeight:o.css("fontWeight"),letterSpacing:o.css("letterSpacing"),whiteSpace:"nowrap"}),a=function(){setTimeout(()=>{if(n===(n=o.val()))return
r.text(n)
const a=r.width(),i=a+e.comfortZone>=t?a+e.comfortZone:t,s=o.width(),l=i<s&&i>=t||i>t&&i<e.maxWidth
l&&o.width(i)})}
r.insertAfter(o)
...
const u={translateMathmlForScreenreaders(e){const t=r()("<div/>").html(e.attr("x-canvaslms-safe-mathml")).html()
const n=r()('<span class="hidden-readable"></span>')
n.html(t)
return n},toMediaCommentLink(e){const t=r()("<a\n        id='media_comment_".concat(Object(s["a"])(r()(e).data("media_comment_id")),"'\n        data-media_comment_type='").concat(Object(s["a"])(r()(e).data("media_comment_type")),"'\n        class='instructure_inline_media_comment ").concat(Object(s["a"])(e.nodeName.toLowerCase()),"_comment'\n        data-alt='").concat(Object(s["a"])(r()(e).attr("data-alt")),"'\n      />"))
t.html(r()(e).html())
...
o.append(r()("<input type='hidden'/>").attr({name:"object_data",value:e.data("uc_snippet")}))
o.append(r()("<input type='hidden'/>").attr({name:"s",value:e.data("uc_sig")}))
r()("body").append(o)
...
o=[]
t={}
e.exports=n=function(e,n,r){var a,i,s,l,c,d,u,b,_
null==r&&(r=true)
...
a=(null!=n?n.decimal:void 0)||t.decimal}u=""+_+a+r
d=o[u]
if(null==d){s=r?3:1
d=o[u]=new RegExp("^\\s*([+-]?(?:(?:\\d{1,3}(?:\\"+_+"\\d{"+s+",3})+)|\\d*))(?:\\"+a+"(\\d*))?\\s*$")}b=e.match(d)
if(!(null!=b&&3===b.length))return NaN
l=b[1].replace(new RegExp("\\"+_,"g"),"")
i=b[2]
c=parseFloat(l+"."+i)
return c}
...
if(t.match(a.push))s=i([],n(l),s)
else if(t.match(a.fixed)){n(l,t)
s=i([],t,s)}else t.match(a.named)&&(s=i({},t,s))}e=r.a.extend(true,e,s)}))
